...
export CFLAGS="${CFLAGS} -Wno-error=deprecated-declarations -Wno-error=cpp -Wno-error=pragmas -Wno-error=deprecated -Wno-incompatible-pointer-types"
export CXXFLAGS="${CXXFLAGS} -Wno-error=deprecated-declarations -Wno-error=cpp -Wno-error=pragmas -Wno-error=deprecated -Wno-incompatible-pointer-types"
